  ...
  <div>
    ...
    <transition name="modal-bounce">
      <div v-if="showModal" class="z-50 fixed overflow-auto inset-0 flex justify-center items-start md:items-center !pt-16 !md:pt-2 !p-2">
        <div class="relative bg-base-100 opacity-100 bg-opacity-100 p-2 md:pt-2 rounded-xl shadow-xl max-h-[100vh - 10%] w-full md:w-auto md:max-w-[100%] overflow-y-visible" @click.stop>
